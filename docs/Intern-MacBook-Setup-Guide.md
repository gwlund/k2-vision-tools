...
### 5.2 Install CLAUDE.md, Zotero Reference, and Skills

The setup script copies these automatically from `claude-config/` in the repo. If you ran the script, these are already installed. To install manually:

```bash
cp ~/Documents/Projects/k2-vision-tools/claude-config/CLAUDE.md ~/.claude/CLAUDE.md
cp ~/Documents/Projects/k2-vision-tools/claude-config/ZOTERO-CLI-REFERENCE.md ~/.claude/ZOTERO-CLI-REFERENCE.md
cp -r ~/Documents/Projects/k2-vision-tools/claude-config/skills/* ~/.claude/skills/
```
