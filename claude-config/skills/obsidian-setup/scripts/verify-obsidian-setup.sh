...
# Note: Do NOT use set -e here. Bash arithmetic like ((counter++))
# returns exit code 1 when the counter value is 0, which would cause
# set -e to terminate the script prematurely.
