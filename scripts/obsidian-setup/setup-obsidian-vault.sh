...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        *)
            ...
            echo "Usage: $0 [--non-interactive] [--vault-path PATH]"
            exit 1
            ;;
    esac
done
...
echo "  4. Generate configuration examples"
echo "  5. Create README and documentation"
echo
...
# Copy Zotero literature note template
if [ -f "$SCRIPT_DIR/templates/Zotero-Literature-Note.md" ]; then
    cp "$SCRIPT_DIR/templates/Zotero-Literature-Note.md" Templates/
    print_success "Installed Literature Note template"
else
...
See full setup guide: [docs/guides/obsidian-zotero-setup-guide.md](docs/guides/obsidian-zotero-setup-guide.md)
...
print_info "Full documentation: docs/guides/obsidian-zotero-setup-guide.md"
echo
